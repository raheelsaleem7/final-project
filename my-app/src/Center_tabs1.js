...
function Center_tabs1() {
    ...
    return (
        ...
        <div className='tab_content1'>
            ...
            <h2 class="woocommerce-loop-product__title">onlu Audio <br />System Multiroom 360</h2></a>
          <div className='for_picture'>
           <img src={image16} className='image11'/>
        </div>
        </div>
